...
module.exports = {
  init: function(app, socket) {
    ...
    app.delete(  '/api/users/:uid', usersController.destroy);  // delete the user with id <:uid> from the database
    ...
    app.delete(  '/api/users/:uid/reviews/:rid', reviewsController.destroy);    // delete the specific review for the given user and review ids
    ...
    app.delete(  '/api/users/:uid/cars/:cid', carsController.destroy);   // delete the specific car for the given user and car ids
    ...
    app.delete(  '/api/users/:uid/lots/:lid', lotsController.destroy);     // Delete the specific lot for a specified user id and lot id
    ...
    app.delete(  '/api/lots/:lid', lotsController.destroy);                // Delete the specific lot for a specified lot id
    ...
    app.delete(  '/api/users/:uid/lots/:lid/spots/:sid', spotsController.destroy); // Delete the speceific spot from the database
    ...
    app.delete(  '/api/feedback/:fid', feedbackController.destroy);  // delete the feedback with id <:fid> from the database
